    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Kareem755@gmail.com", "Kareem Mahdy", new DateTime(2022, 5, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "01276983179" },
                    { 2, "mazenahmed15@gmail.com", "Mazen Ahmed", new DateTime(2024, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "015762383004" }
                });

            migrationBuilder.InsertData(
                table: "Branches",
                columns: new[] { "Code", "ManagerId", "Name", "PhoneNumber", "Address_City", "Address_Country", "Address_Street" },
                values: new object[,]
                {
                    { "BR001", 1, "Main Branch", "0123456789", "Cairo", "Egypt", "Road 9, Maadi" },
                    { "BR002", 2, "City Branch", "9876543210", "Alexandria", "Egypt", "Corniche Road" }
                });
